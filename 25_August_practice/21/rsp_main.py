...
def enter_gs():
    ...
    if e_choice == "1":
        ...
        ELEVATOR("open_out", 1)
        time.sleep(2)
        print("당신은 엘리베이터에 탑승해 한쪽 벽면에 기댄다.")
        time.sleep(2)
        ...
        print("당신은 그제야 이상함을 느끼고 주변을 살피다가 휴대폰을 다시 켜본다.")
        time.sleep(2)
        print("당신의 휴대폰에는 아까 본 텍스트 파일의 첫번째 문장이 떠 있다.\n")
        time.sleep(2)
        print(GUIDELINE["f"])
        time.sleep(2)
        print("\n당신은 그제서야 텍스트 파일에서 보았던 괴담에 들어왔음을 깨닫는다.")
        time.sleep(2)
        my_turn(top_floor)
