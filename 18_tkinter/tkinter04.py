...
def calculate_order():
    ...
    if selected_order:
        ...
        messagebox.showinfo("주문확인", order_text)
    else:
        messagebox.showwarning("주문오류", "선택된 주문이 없습니다")
...
log_btn = tk.Button(root, text="주문내역", command=history_btn)
